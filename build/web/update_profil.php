...
$user=$_SESSION['id'];
$q1=mysql_query("select * from user where id=$user");
...
<tr><td>No HP</td><td>:</td><td><input type="text" name="hp" size="18" value="<?php echo $data['telp'];?>">
...
<div id="clearer"></div>
<div id="footer">2015 Copyright ESTO. All Right Reserved </div>
</div>
</body>
</html>